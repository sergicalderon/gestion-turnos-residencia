...
Aplica las migraciones SQL de `supabase/migrations/` en orden cronológico.
...
En Vercel, añade las mismas variables de entorno antes de desplegar. Antes de publicar una versión con cambios de base de datos, aplica primero las migraciones nuevas en Supabase.
